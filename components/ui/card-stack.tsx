...
export function CardStack<T extends CardStackItem>({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="pointer-events-none absolute inset-x-0 top-6 mx-auto h-48 w-[70%] rounded-full bg-cyan-500/10 blur-3xl"
          aria-hidden="true"
        />
        <div
            ...
            {items.map((item, i) => {
              ...
              return (
                <motion.div
                  key={item.id}
                  className={cn(
                    "absolute bottom-0 overflow-hidden rounded-2xl border-4 border-cyan-500/20 shadow-xl will-change-transform select-none dark:border-cyan-400/15",
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    on ? "bg-cyan-400 shadow-[0_0_8px_rgba(34,211,238,0.8)]" : "bg-cyan-500/30 hover:bg-cyan-500/60",
                  )}
